...
<section class="content-header">
    <h1>
        Dokumentasi Sanitasi        <small>Edit Dokumentasi Sanitasi</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Dokumentasi Sanitasi</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/dokumentasi_sanitasi/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="dokumentasi_sanitasi_sumsel_id" id="dokumentasi_sanitasi_sumsel_id" data-placeholder="Select Dokumentasi Sanitasi Sumsel Id" >
                                    ...
                                    <option <?=  $row->air_bersih_id ==  $dokumentasi_sanitasi->dokumentasi_sanitasi_sumsel_id ? 'selected' : ''; ?> value="<?= $row->air_bersih_id ?>"><?= $row->text_kecamatan; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="dokumentasi_sanitasi_file_uuid" id="dokumentasi_sanitasi_file_uuid" type="hidden" value="<?= set_value('dokumentasi_sanitasi_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_sanitasi_file_name" id="dokumentasi_sanitasi_file_name" type="hidden" value="<?= set_value('dokumentasi_sanitasi_file_name', $dokumentasi_sanitasi->file); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="dokumen_tanggal"  placeholder="Tanggal Dokumentasi" id="dokumen_tanggal" value="<?= set_value('dokumentasi_sanitasi_dokumen_tanggal_name', $dokumentasi_sanitasi->dokumen_tanggal); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="dokumentasi_nama" id="dokumentasi_nama" placeholder="Keterangan" value="<?= set_value('dokumentasi_nama', $dokumentasi_sanitasi->dokumentasi_nama); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_dokumentasi_sanitasi.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#dokumentasi_sanitasi_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#dokumentasi_sanitasi_file_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/dokumentasi_sanitasi/get_file_file/<?= $dokumentasi_sanitasi->kode_dss; ?>',
