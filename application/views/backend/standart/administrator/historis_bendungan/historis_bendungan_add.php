...
<section class="content-header">
    <h1>
        Historis Bendungan        <small><?= cclang('new', ['Historis Bendungan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Bendungan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="bendungan_id" id="bendungan_id" data-placeholder="Select Bendungan Id" >
                                    ...
                                    <option value="<?= $row->bendungan_id ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="historis_vefektif" id="historis_vefektif" placeholder="Volume Efektif" value="<?= set_value('historis_vefektif'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="historis_vpenanganan" id="historis_vpenanganan" placeholder="Volume Penanganan" value="<?= set_value('historis_vpenanganan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="maplinks_id" id="maplinks_id" placeholder="Maplinks Id" value="<?= set_value('maplinks_id'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_bendungan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
