...
<section class="content-header">
    <h1>
        Jalan Provinsi        <small><?= cclang('new', ['Jalan Provinsi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Jalan Provinsi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jalan_panjang" id="jalan_panjang" placeholder="Jalan Panjang" value="<?= set_value('jalan_panjang'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/jalan_provinsi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
