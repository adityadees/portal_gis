...
<section class="content-header">
    <h1>
        Dokumentasi Stanplat        <small><?= cclang('new', ['Dokumentasi Stanplat']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Stanplat']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="dokumentasi_stanplat_id" id="dokumentasi_stanplat_id" data-placeholder="Select Dokumentasi Stanplat Id" >
                                    ...
                                    <option value="<?= $row->stanplat_id ?>"><?= $row->stanplat_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_stanplat_file_uuid" id="dokumentasi_stanplat_file_uuid" type="hidden" value="<?= set_value('dokumentasi_stanplat_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_stanplat_file_name" id="dokumentasi_stanplat_file_name" type="hidden" value="<?= set_value('dokumentasi_stanplat_file_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_stanplat/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#dokumentasi_stanplat_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#dokumentasi_stanplat_file_galery').fineUploader('deleteFile', id_file);
                }
