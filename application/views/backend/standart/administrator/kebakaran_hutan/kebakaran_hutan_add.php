...
<section class="content-header">
    <h1>
        Kebakaran Hutan        <small><?= cclang('new', ['Kebakaran Hutan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kebakaran Hutan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kecamatan_rawan" id="kecamatan_rawan" placeholder="Kecamatan Rawan" value="<?= set_value('kecamatan_rawan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kecamatan_sangat_rawan" id="kecamatan_sangat_rawan" placeholder="Kecamatan Sangat Rawan" value="<?= set_value('kecamatan_sangat_rawan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="desa_rawan" id="desa_rawan" placeholder="Desa Rawan" value="<?= set_value('desa_rawan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="desa_sangat_rawan" id="desa_sangat_rawan" placeholder="Desa Sangat Rawan" value="<?= set_value('desa_sangat_rawan'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/kebakaran_hutan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
