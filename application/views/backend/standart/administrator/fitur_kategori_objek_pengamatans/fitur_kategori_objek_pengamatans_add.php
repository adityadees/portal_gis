...
<section class="content-header">
    <h1>
        Fitur Kategori Objek Pengamatans        <small><?= cclang('new', ['Fitur Kategori Objek Pengamatans']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Fitur Kategori Objek Pengamatans']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/fitur_kategori_objek_pengamatans/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
