...
<section class="content-header">
    <h1>
        Tol Ln 2017 Sumatera Selatan Pubtr Geo        <small><?= cclang('new', ['Tol Ln 2017 Sumatera Selatan Pubtr Geo']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Tol Ln 2017 Sumatera Selatan Pubtr Geo']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tol_ln_2017_sumatera_selatan_pubtr_geo_id" id="tol_ln_2017_sumatera_selatan_pubtr_geo_id" placeholder="Tol Ln 2017 Sumatera Selatan Pubtr Geo Id" value="<?= set_value('tol_ln_2017_sumatera_selatan_pubtr_geo_id'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="jalanrencana" id="jalanrencana" placeholder="Jalanrencana" value="<?= set_value('jalanrencana'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ruas" id="ruas" placeholder="Ruas" value="<?= set_value('ruas'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="status_tol" id="status_tol" placeholder="Status Tol" value="<?= set_value('status_tol'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="pemilik" id="pemilik" placeholder="Pemilik" value="<?= set_value('pemilik'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/tol_ln_2017_sumatera_selatan_pubtr_geo/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
