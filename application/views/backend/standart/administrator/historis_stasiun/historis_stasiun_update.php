...
<section class="content-header">
    <h1>
        Historis Stasiun        <small>Edit Historis Stasiun</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Historis Stasiun</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/historis_stasiun/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_historis_stasiun', 
                            'class'   => 'form-horizontal', 
                            'id'      => 'form_historis_stasiun', 
                            'method'  => 'POST'
                            ]); ?>
                            ...
                            <div class="col-sm-2">
                                <select  class="form-control chosen chosen-select-deselect" name="historis_tahun" id="historis_tahun" data-placeholder="Select Historis Tahun" >
                                    ...
                                    <option <?=  $i ==  $historis_stasiun->historis_tahun ? 'selected' : ''; ?> value="<?= $i; ?>"><?= $i; ?></option>
                                    <?php }; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="historis_sdana" id="historis_sdana" placeholder="Historis Sdana" value="<?= set_value('historis_sdana', $historis_stasiun->historis_sdana); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <textarea id="historis_ket" name="historis_ket" rows="10" cols="80"> <?= set_value('historis_ket', $historis_stasiun->historis_ket); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
    ...
    $(document).ready(function(){
      ...
      $('#btn_cancel').click(function(){
        swal({
          ...
          function(isConfirm){
            if (isConfirm) {
              window.location.href = BASE_URL + 'administrator/historis_stasiun';
            }
          });
      ...
      $('.btn_save').click(function(){
        ...
        var form_historis_stasiun = $('#form_historis_stasiun');
        var data_post = form_historis_stasiun.serializeArray();
        ...
        $.ajax({
          url: form_historis_stasiun.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#historis_stasiun_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
