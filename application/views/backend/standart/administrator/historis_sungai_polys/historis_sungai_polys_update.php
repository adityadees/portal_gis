                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/historis_sungai_polys/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="historis_tahun" id="historis_tahun" placeholder="Historis Tahun" value="<?= set_value('historis_tahun', $historis_sungai_polys->historis_tahun); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
