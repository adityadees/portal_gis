...
<section class="content-header">
    <h1>
        Historis Jembatan Pt 250k        <small><?= cclang('new', ['Historis Jembatan Pt 250k']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Jembatan Pt 250k']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_historis_jembatan_pt_250k" id="kode_historis_jembatan_pt_250k" placeholder="Kode Historis Jembatan Pt 250k" value="<?= set_value('kode_historis_jembatan_pt_250k'); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="jembatan_pt_250k_id" id="jembatan_pt_250k_id" data-placeholder="Select Jembatan Pt 250k Id" >
                                    ...
                                    <option value="<?= $row->jembatan_id ?>"><?= $row->jembatan_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
                                </small>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_jembatan_pt_250k/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
