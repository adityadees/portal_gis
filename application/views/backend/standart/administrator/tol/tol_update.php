            ...
            <div class="box box-warning">
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/tol/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_tol', 
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="tol_ln_2017_sumatera_selatan_pubtr_geo_id" id="tol_ln_2017_sumatera_selatan_pubtr_geo_id" placeholder="Nama Tol" value="<?= set_value('tol_ln_2017_sumatera_selatan_pubtr_geo_id', $tol->tol_ln_2017_sumatera_selatan_pubtr_geo_id); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="jalanrencana" name="jalanrencana" rows="10" cols="80"> <?= set_value('jalanrencana', $tol->jalanrencana); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="ruas" name="ruas" rows="10" cols="80"> <?= set_value('ruas', $tol->ruas); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="status_tol" name="status_tol" rows="10" cols="80"> <?= set_value('status_tol', $tol->status_tol); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="pemilik" name="pemilik" rows="10" cols="80"> <?= set_value('pemilik', $tol->pemilik); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#tol_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
