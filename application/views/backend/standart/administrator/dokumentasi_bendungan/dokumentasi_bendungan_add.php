...
<section class="content-header">
    <h1>
        Dokumentasi Bendungan        <small><?= cclang('new', ['Dokumentasi Bendungan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Bendungan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_bendungan_file_uuid" id="dokumentasi_bendungan_file_uuid" type="hidden" value="<?= set_value('dokumentasi_bendungan_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_bendungan_file_name" id="dokumentasi_bendungan_file_name" type="hidden" value="<?= set_value('dokumentasi_bendungan_file_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="dokumentasi_nama" id="dokumentasi_nama" placeholder="Dokumentasi Nama" value="<?= set_value('dokumentasi_nama'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_bendungan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#dokumentasi_bendungan_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#dokumentasi_bendungan_file_galery').fineUploader('deleteFile', id_file);
                }
