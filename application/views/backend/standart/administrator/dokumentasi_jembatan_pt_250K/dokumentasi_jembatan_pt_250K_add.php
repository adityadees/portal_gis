...
<section class="content-header">
    <h1>
        Dokumentasi Jembatan Pt 250K        <small><?= cclang('new', ['Dokumentasi Jembatan Pt 250K']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Jembatan Pt 250K']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_jembatan_pt_250K_file_uuid" id="dokumentasi_jembatan_pt_250K_file_uuid" type="hidden" value="<?= set_value('dokumentasi_jembatan_pt_250K_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_jembatan_pt_250K_file_name" id="dokumentasi_jembatan_pt_250K_file_name" type="hidden" value="<?= set_value('dokumentasi_jembatan_pt_250K_file_name'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_jembatan_pt_250K/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#dokumentasi_jembatan_pt_250K_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#dokumentasi_jembatan_pt_250K_file_galery').fineUploader('deleteFile', id_file);
                }
