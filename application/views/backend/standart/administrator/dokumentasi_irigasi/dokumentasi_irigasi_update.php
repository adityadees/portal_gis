...
<section class="content-header">
    <h1>
        Dokumentasi Irigasi        <small>Edit Dokumentasi Irigasi</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Dokumentasi Irigasi</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/dokumentasi_irigasi/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="irigasi_id" id="irigasi_id" data-placeholder="Select Irigasi Id" >
                                    ...
                                    <option <?=  $row->irigasi_id ==  $dokumentasi_irigasi->irigasi_id ? 'selected' : ''; ?> value="<?= $row->irigasi_id ?>"><?= $row->nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="dokumentasi_nama" id="dokumentasi_nama" placeholder="Keterangan" value="<?= set_value('dokumentasi_nama', $dokumentasi_irigasi->dokumentasi_nama); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file data_file_uuid" name="dokumentasi_irigasi_file_uuid" id="dokumentasi_irigasi_file_uuid" type="hidden" value="<?= set_value('dokumentasi_irigasi_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_irigasi_file_name" id="dokumentasi_irigasi_file_name" type="hidden" value="<?= set_value('dokumentasi_irigasi_file_name', $dokumentasi_irigasi->file); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="dokumen_tanggal"  placeholder="Tanggal Dokumentasi" id="dokumen_tanggal" value="<?= set_value('dokumentasi_irigasi_dokumen_tanggal_name', $dokumentasi_irigasi->dokumen_tanggal); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_dokumentasi_irigasi.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#dokumentasi_irigasi_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
       ...
       $('#dokumentasi_irigasi_file_galery').fineUploader({
          ...
          thumbnails: {
           ...
           session : {
             endpoint: BASE_URL + 'administrator/dokumentasi_irigasi/get_file_file/<?= $dokumentasi_irigasi->kode_dirigasi; ?>',
