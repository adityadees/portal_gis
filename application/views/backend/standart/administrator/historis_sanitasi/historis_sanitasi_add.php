...
<section class="content-header">
    <h1>
        Historis Sanitasi        <small><?= cclang('new', ['Historis Sanitasi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Sanitasi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="sanitasi_sumsel_id" id="sanitasi_sumsel_id" data-placeholder="Select Sanitasi Sumsel Id" >
                                    ...
                                    <option value="<?= $row->sanitasi ?>"><?= $row->text_kecamatan; ?></option>
                                    <?php endforeach; ?>  
                                </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_sanitasi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
