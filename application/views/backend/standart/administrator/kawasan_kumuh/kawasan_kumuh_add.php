...
<section class="content-header">
    <h1>
        Kawasan Kumuh        <small><?= cclang('new', ['Kawasan Kumuh']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Kawasan Kumuh']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kawasan_kumuh_id" id="kawasan_kumuh_id" placeholder="Kawasan Kumuh Id" value="<?= set_value('kawasan_kumuh_id'); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tipology" id="tipology" placeholder="Tipology" value="<?= set_value('tipology'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="no_kawasan" id="no_kawasan" placeholder="No Kawasan" value="<?= set_value('no_kawasan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kawas" id="nama_kawas" placeholder="Nama Kawas" value="<?= set_value('nama_kawas'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tambahan" id="tambahan" placeholder="Tambahan" value="<?= set_value('tambahan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="kawasan_st" id="kawasan_st" placeholder="Kawasan St" value="<?= set_value('kawasan_st'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="peruntukan" id="peruntukan" placeholder="Peruntukan" value="<?= set_value('peruntukan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="wilayah_da" id="wilayah_da" placeholder="Wilayah Da" value="<?= set_value('wilayah_da'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="prioritas" id="prioritas" placeholder="Prioritas" value="<?= set_value('prioritas'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="tingkat_ke" id="tingkat_ke" placeholder="Tingkat Ke" value="<?= set_value('tingkat_ke'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="dampingan" id="dampingan" placeholder="Dampingan" value="<?= set_value('dampingan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kab_kota" id="kab_kota" placeholder="Kab Kota" value="<?= set_value('kab_kota'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="objectid" id="objectid" placeholder="Objectid" value="<?= set_value('objectid'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="nama_kaw" id="nama_kaw" placeholder="Nama Kaw" value="<?= set_value('nama_kaw'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="luas_kaw" id="luas_kaw" placeholder="Luas Kaw" value="<?= set_value('luas_kaw'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="shape_leng" id="shape_leng" placeholder="Shape Leng" value="<?= set_value('shape_leng'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="shape_area" id="shape_area" placeholder="Shape Area" value="<?= set_value('shape_area'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="luas_ha" id="luas_ha" placeholder="Luas Ha" value="<?= set_value('luas_ha'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kawasan_ku" id="kawasan_ku" placeholder="Kawasan Ku" value="<?= set_value('kawasan_ku'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/kawasan_kumuh/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
