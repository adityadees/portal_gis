...
<section class="content-header">
    <h1>
        Historis Sanitasi Sumsel        <small><?= cclang('new', ['Historis Sanitasi Sumsel']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Sanitasi Sumsel']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_historis_sanitasi_sumsel" id="kode_historis_sanitasi_sumsel" placeholder="Kode Historis Sanitasi Sumsel" value="<?= set_value('kode_historis_sanitasi_sumsel'); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_sanitasi_sumsel/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
