...
<section class="content-header">
    <h1>
        Sanitasi        <small>Edit Sanitasi</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Sanitasi</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/sanitasi/edit_save/'.$this->uri->segment(4)), [
                            'name'    => 'form_sanitasi', 
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="air_bersih_id" id="air_bersih_id" placeholder="Air Bersih Id" value="<?= set_value('air_bersih_id', $sanitasi->air_bersih_id); ?>">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kabupaten_kota" id="kabupaten_kota" placeholder="Kabupaten Kota" value="<?= set_value('kabupaten_kota', $sanitasi->kabupaten_kota); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kecamatan" id="kecamatan" placeholder="Kecamatan" value="<?= set_value('kecamatan', $sanitasi->kecamatan); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_wilayah" id="kode_wilayah" placeholder="Kode Wilayah" value="<?= set_value('kode_wilayah', $sanitasi->kode_wilayah); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kode_kecamatan" id="kode_kecamatan" placeholder="Kode Kecamatan" value="<?= set_value('kode_kecamatan', $sanitasi->kode_kecamatan); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="luas" id="luas" placeholder="Luas" value="<?= set_value('luas', $sanitasi->luas); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="sanitasi" name="sanitasi" rows="10" cols="80"> <?= set_value('sanitasi', $sanitasi->sanitasi); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="air_bersih" name="air_bersih" rows="10" cols="80"> <?= set_value('air_bersih', $sanitasi->air_bersih); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="kk_mbr" name="kk_mbr" rows="10" cols="80"> <?= set_value('kk_mbr', $sanitasi->kk_mbr); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="kk_nonmbr" name="kk_nonmbr" rows="10" cols="80"> <?= set_value('kk_nonmbr', $sanitasi->kk_nonmbr); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="perkebunan" name="perkebunan" rows="10" cols="80"> <?= set_value('perkebunan', $sanitasi->perkebunan); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        .done(function(res) {
          if(res.success) {
            var id = $('#sanitasi_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
