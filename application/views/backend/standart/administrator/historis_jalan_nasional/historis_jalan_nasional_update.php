                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <?= form_open(base_url('administrator/historis_jalan_nasional/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="historis_namakeg" id="historis_namakeg" placeholder="Historis Namakeg" value="<?= set_value('historis_namakeg', $historis_jalan_nasional->historis_namakeg); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
