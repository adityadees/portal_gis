...
<section class="content-header">
    <h1>
        Jembatan Pt 250k        <small>Edit Jembatan Pt 250k</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Jembatan Pt 250k</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/jembatan_pt_250k/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="jembatan_id" id="jembatan_id" placeholder="Jembatan Id" value="<?= set_value('jembatan_id', $jembatan_pt_250k->jembatan_id); ?>">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_jembatan_pt_250k.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#jembatan_pt_250k_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
