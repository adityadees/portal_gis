...
<section class="content-header">
    <h1>
        Sanitasi Sumsels        <small><?= cclang('new', ['Sanitasi Sumsels']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Sanitasi Sumsels']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <textarea id="text_kecamatan" name="text_kecamatan" rows="5" cols="80"><?= set_value('Text Kecamatan'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="sanitasi" id="sanitasi" placeholder="Sanitasi" value="<?= set_value('sanitasi'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="air_bersih" id="air_bersih" placeholder="Air Bersih" value="<?= set_value('air_bersih'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kk_mbr" id="kk_mbr" placeholder="Kk Mbr" value="<?= set_value('kk_mbr'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="kk_nonmbr" id="kk_nonmbr" placeholder="Kk Nonmbr" value="<?= set_value('kk_nonmbr'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="perkebunan" id="perkebunan" placeholder="Perkebunan" value="<?= set_value('perkebunan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/sanitasi_sumsels/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
