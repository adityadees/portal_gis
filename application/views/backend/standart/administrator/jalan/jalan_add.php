...
<section class="content-header">
    <h1>
        Jalan        <small><?= cclang('new', ['Jalan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Jalan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_jalan', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select" name="jalan_status" id="jalan_status" data-placeholder="Select Jalan Status" >
                                    ...
                                    <option value="Jalan Kabupaten / Kota">Jalan Kabupaten / Kota</option>
                                    </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="jalan_panjang" id="jalan_panjang" placeholder="Jalan Panjang (M)" value="<?= set_value('jalan_panjang'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/jalan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
