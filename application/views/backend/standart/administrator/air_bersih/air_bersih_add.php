...
<section class="content-header">
    <h1>
        Air Bersih        <small><?= cclang('new', ['Air Bersih']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Air Bersih']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="text_kecamatan" id="text_kecamatan" placeholder="Text Kecamatan" value="<?= set_value('text_kecamatan'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="air_bers_1" id="air_bers_1" placeholder="Air Bers 1" value="<?= set_value('air_bers_1'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/air_bersih/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
