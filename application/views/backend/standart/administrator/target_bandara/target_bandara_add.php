...
<section class="content-header">
    <h1>
        Target Bandara        <small><?= cclang('new', ['Target Bandara']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Target Bandara']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/target_bandara/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
