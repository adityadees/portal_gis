...
<section class="content-header">
    <h1>
        Target        <small><?= cclang('new', ['Target']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Target']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_target', 
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="maplink_id" id="maplink_id" data-placeholder="Select Maplink Id" >
                                    ...
                                    <option value="<?= $row->maplink_id ?>"><?= $row->maplink_nama; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="target_data_id" id="target_data_id" placeholder="Target Data Id" value="<?= set_value('target_data_id'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="target_volume" id="target_volume" placeholder="Target Volume" value="<?= set_value('target_volume'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/target/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
