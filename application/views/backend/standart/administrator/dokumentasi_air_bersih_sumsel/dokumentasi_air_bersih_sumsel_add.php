...
<section class="content-header">
    <h1>
        Dokumentasi Air Bersih Sumsel        <small><?= cclang('new', ['Dokumentasi Air Bersih Sumsel']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Air Bersih Sumsel']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="air_bersih_sumsel_id" id="air_bersih_sumsel_id" data-placeholder="Select Air Bersih Sumsel Id" >
                                    ...
                                    <option value="<?= $row->air_bersih_id ?>"><?= $row->air_bersih_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="dokumentasi_air_bersih_sumsel_file_galery_listed"></div>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_air_bersih_sumsel/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            ...
            $('.message').fadeIn();
            resetForm();
            $('#dokumentasi_air_bersih_sumsel_file_galery').find('li').each(function() {
               $('#dokumentasi_air_bersih_sumsel_file_galery').fineUploader('deleteFile', $(this).attr('qq-file-id'));
            });
