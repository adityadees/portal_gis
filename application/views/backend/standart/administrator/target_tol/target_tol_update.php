...
<section class="content-header">
    <h1>
        Target Tol        <small>Edit Target Tol</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit Target Tol</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/target_tol/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="target_data_id" id="target_data_id" data-placeholder="Select Target Data Id" >
                                    ...
                                    <option <?=  $row->tol_ln_2017_sumatera_selatan_pubtr_geo_id ==  $target_tol->target_data_id ? 'selected' : ''; ?> value="<?= $row->tol_ln_2017_sumatera_selatan_pubtr_geo_id ?>"><?= $row->ruas; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-2">
                                <select  class="form-control chosen chosen-select-deselect" name="target_tahun" id="target_tahun" data-placeholder="Select Target Tahun" >
                                    ...
                                    <option <?=  $i ==  $target_tol->target_tahun ? 'selected' : ''; ?> value="<?= $i; ?>"><?= $i; ?></option>
                                    <?php }; ?>  
                                </select>
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="target_volume" id="target_volume" placeholder="Target Volume" value="<?= set_value('target_volume', $target_tol->target_volume); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="target_satuan" id="target_satuan" placeholder="Satuan" value="<?= set_value('target_satuan', $target_tol->target_satuan); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_target_tol.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#target_tol_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
