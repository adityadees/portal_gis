...
<section class="content-header">
    <h1>
        Historis Pelabuhan        <small><?= cclang('new', ['Historis Pelabuhan']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Pelabuhan']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="pelabuhan_id" id="pelabuhan_id" data-placeholder="Select Pelabuhan Id" >
                                    ...
                                    <option value="<?= $row->pelabuhan_id ?>"><?= $row->pelabuhan_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_pelabuhan/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
