...
<section class="content-header">
    <h1>
        Historis Jalan Provinsi        <small><?= cclang('new', ['Historis Jalan Provinsi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Jalan Provinsi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="historis_vpenanganan" id="historis_vpenanganan" placeholder="Historis Penanganan" value="<?= set_value('historis_vpenanganan'); ?>">
                                <small class="info help-block">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="historis_sta" id="historis_sta" placeholder="Historis Sta" value="<?= set_value('historis_sta'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_jalan_provinsi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
