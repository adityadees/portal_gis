...
<section class="content-header">
    <h1>
        Historis Bendungans        <small><?= cclang('new', ['Historis Bendungans']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Bendungans']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="bendungan_id" id="bendungan_id" data-placeholder="Select Bendungan Id" >
                                    ...
                                    <option value="<?= $row->bendungan_id ?>"><?= $row->bendungan_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="historis_sdana" id="historis_sdana" placeholder="Historis Sdana" value="<?= set_value('historis_sdana'); ?>">
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_bendungans/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
