                        ...
                        <?= form_open(base_url('administrator/dokumentasi_jalan_nasional/edit_save/'.$this->uri->segment(4)), [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="dokumentasi_jalan_id" id="dokumentasi_jalan_id" data-placeholder="Select Dokumentasi Jalan Id" >
                                    ...
                                    <option <?=  $row->jalan_id ==  $dokumentasi_jalan_nasional->dokumentasi_jalan_id ? 'selected' : ''; ?> value="<?= $row->jalan_id ?>"><?= $row->jalan_id; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="input-group date col-sm-8">
                              <input type="text" class="form-control pull-right datepicker" name="dokumen_tanggal"  placeholder="Dokumen Tanggal" id="dokumen_tanggal" value="<?= set_value('dokumentasi_jalan_nasional_dokumen_tanggal_name', $dokumentasi_jalan_nasional->dokumen_tanggal); ?>">
                            </div>
                            <small class="info help-block">
                            </small>
                            </div>
