...
<section class="content-header">
    <h1>
        Dokumentasi Air Bersih        <small><?= cclang('new', ['Dokumentasi Air Bersih']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Air Bersih']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_air_bersih_file_uuid" id="dokumentasi_air_bersih_file_uuid" type="hidden" value="<?= set_value('dokumentasi_air_bersih_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_air_bersih_file_name" id="dokumentasi_air_bersih_file_name" type="hidden" value="<?= set_value('dokumentasi_air_bersih_file_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_air_bersih/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#dokumentasi_air_bersih_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#dokumentasi_air_bersih_file_galery').fineUploader('deleteFile', id_file);
                }
