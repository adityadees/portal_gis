...
<section class="content-header">
    <h1>
        Dokumentasi Kawasan Kumuh        <small><?= cclang('new', ['Dokumentasi Kawasan Kumuh']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Dokumentasi Kawasan Kumuh']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kawasan_kumuh_id" id="kawasan_kumuh_id" data-placeholder="Select Kawasan Kumuh Id" >
                                    ...
                                    <option value="<?= $row->kawasan_kumuh_id ?>"><?= $row->nama_kawas; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                            ...
                            <div class="col-sm-8">
                                ...
                                <input class="data_file" name="dokumentasi_kawasan_kumuh_file_uuid" id="dokumentasi_kawasan_kumuh_file_uuid" type="hidden" value="<?= set_value('dokumentasi_kawasan_kumuh_file_uuid'); ?>">
                                <input class="data_file" name="dokumentasi_kawasan_kumuh_file_name" id="dokumentasi_kawasan_kumuh_file_name" type="hidden" value="<?= set_value('dokumentasi_kawasan_kumuh_file_name'); ?>">
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/dokumentasi_kawasan_kumuh/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#dokumentasi_kawasan_kumuh_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#dokumentasi_kawasan_kumuh_file_galery').fineUploader('deleteFile', id_file);
                }
