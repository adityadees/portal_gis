...
<section class="content-header">
    <h1>
        Target Sanitasi        <small><?= cclang('new', ['Target Sanitasi']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Target Sanitasi']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/target_sanitasi/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
