...
<section class="content-header">
    <h1>
        Historis Kawasan Kumuh        <small><?= cclang('new', ['Historis Kawasan Kumuh']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['Historis Kawasan Kumuh']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kawasan_kumuh_id" id="kawasan_kumuh_id" data-placeholder="Select Kawasan Kumuh Id" >
                                    ...
                                    <option value="<?= $row->kawasan_kumuh_id ?>"><?= $row->nama_kaw; ?></option>
                                    <?php endforeach; ?>  
                                </select>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/historis_kawasan_kumuh/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
