<script>
  ...
  callback: function () {
    ...
    var rows = [
         <?php foreach ($sungai_pol->result_array() as $i) :?>
    ...
    var options = {
        title: 'Perbandingan Pembangunan dan Target Pada Sungai Pol',
        height: 500,
        width: 1000,
    };


    var chart = new google.visualization.ColumnChart(document.getElementById('sungaipol'));
