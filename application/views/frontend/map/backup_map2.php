  ...
  <body>
    ...
    <script>
      ...
      function initMap() {
        ...
        var urla = 'https://d2ad6b4ur7yvpq.cloudfront.net/naturalearth-3.3.0/ne_50m_rivers_lake_centerlines.geojson';
        ...
        var ced = google.maps.event.addListener(data_layer, 'click', function(event) {
        ...
        data_layer.data.addListener('mouseover', function (event) {
          data_layer.data.revertStyle();
          data_layer.data.overrideStyle(event.feature, {
            strokeColor: 'red',
            strokeWeight: 8
        ...
        data_layer.data.addListener('mouseout', function (event) {
          data_layer.data.revertStyle();
        });
