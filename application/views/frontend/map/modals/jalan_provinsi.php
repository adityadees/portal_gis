...
<?php foreach($jalan_provinsi->result_array() as $i) : ?>
  <div id="myModal<?= $i['jalan_id']; ?>jalan_provinsi" class="modal fade" role="dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul class="nav nav-pills nav-fill nav-tabs">
            <li class="active"><a data-toggle="pill" href="#home<?= $i['jalan_id']; ?>jalan_provinsi">Data Umum</a></li>
            <li><a data-toggle="pill" href="#menu1<?= $i['jalan_id']; ?>jalan_provinsi">Historis Penanganan</a></li>
            <li><a data-toggle="pill" href="#menu3<?= $i['jalan_id']; ?>jalan_provinsi">Target</a></li>
            <li><a data-toggle="pill" href="#menu2<?= $i['jalan_id']; ?>jalan_provinsi">Dokumentasi</a></li>
          </ul>

          <div class="tab-content">
            <div id="home<?= $i['jalan_id']; ?>jalan_provinsi" class="tab-pane fade in active">
          ...
          <div id="menu1<?= $i['jalan_id']; ?>jalan_provinsi" class="tab-pane fade">
            <table class="table table-striped">
              <thead>
                <tr>
                  <th>No.</th>
              ...
              <tbody>
                <?php
                $kode=$i['jalan_id'];
                $ghistoris=$this->modelgeojson->get_data_historis_jalan_provinsi($kode);
                $no=0;
          ...
          <div id="menu3<?= $i['jalan_id']; ?>jalan_provinsi" class="tab-pane fade">
           <table class="table table-striped">
            <thead>
              <tr>
                <th>No.</th>
        ...
        <div id="menu2<?= $i['jalan_id']; ?>jalan_provinsi" class="tab-pane fade">
          ...
          <table class="table table-striped">
            ...
            <tbody>
              <?php
              $kode=$i['jalan_id'];
              $gdokumen=$this->modelgeojson->get_dokumen_jalan_provinsi($kode);
              $no=0;
