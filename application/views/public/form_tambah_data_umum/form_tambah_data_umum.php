...
<?= form_open('', [
    ...
    'class'   => 'form-horizontal form_form_tambah_data_umum', 
...
<div class="form-group ">
    ...
    <div class="col-sm-8">
        ...
        <input class="data_file" name="form_tambah_data_umum_file_uuid" id="form_tambah_data_umum_file_uuid" type="hidden" >
        <input class="data_file" name="form_tambah_data_umum_file_name" id="form_tambah_data_umum_file_name" type="hidden" >
    ...
    $(document).ready(function(){
     ...
     $('input[type="checkbox"].flat-red').iCheck({
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + 'form/form_tambah_data_umum/submit',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id_file = $('#form_tambah_data_umum_file_galery').find('li').attr('qq-file-id');
            ...
            if (typeof id_file !== 'undefined') {
                    $('#form_tambah_data_umum_file_galery').fineUploader('deleteFile', id_file);
                }
       ...
       $('#form_tambah_data_umum_file_galery').fineUploader({
          ...
          request: {
              endpoint: BASE_URL + 'form/form_tambah_data_umum/upload_file_file',
              params : params
          },
          deleteFile: {
              enabled: true, 
              endpoint: BASE_URL + 'form/form_tambah_data_umum/delete_file_file',
          },
          thumbnails: {
              placeholders: {
          ...
          callbacks: {
              ...
              onSubmit : function(id, name) {
                  ...
                  $.get(BASE_URL + 'form/form_tambah_data_umum/delete_file_file/' + uuid);
              },
