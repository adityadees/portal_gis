...
class Model_historis_sanitasi_sumsel extends MY_Model {
	...
	public function count_all($q = null, $field = null)
	{
        ...
        if (empty($field)) {
	        foreach ($this->field_search as $field) {
	            if ($iterasi == 1) {
	                $where .= "historis_sanitasi_sumsel.".$field . " LIKE '%" . $q . "%' ";
	            } else {
	                $where .= "OR " . "historis_sanitasi_sumsel.".$field . " LIKE '%" . $q . "%' ";
	            }
	            $iterasi++;
	        }
	...
	public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
	{
        ...
        $this->db->order_by('historis_sanitasi_sumsel.'.$this->primary_key, "DESC");
		$query = $this->db->get($this->table_name);
...
/* End of file Model_historis_sanitasi_sumsel.php */
/* Location: ./application/models/Model_historis_sanitasi_sumsel.php */