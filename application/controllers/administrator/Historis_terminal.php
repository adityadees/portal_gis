...
class Historis_terminal extends Admin	
{
	...
	*/
	public function add_save()
	{
		...
		$this->form_validation->set_rules('terminal_id', 'Nama Terminal', 'trim|required');
		...
		$this->form_validation->set_rules('historis_sdana', 'Sumber Dana', 'trim|required|max_length[11]');
